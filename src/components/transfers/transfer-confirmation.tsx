...
export function TransferConfirmation({ transferData, onConfirm, onEdit }: TransferConfirmationProps) {
      ...
      <CardContent className="space-y-4">
        <div className="bg-muted p-4 rounded-lg">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-primary">{formatCurrency(Number(transferData.amount))}</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          {transferData.type === "nabank" && (
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium">{transferData.recipientAccount}</span>
            </div>
          )}
          ...
          {transferData.type === "external" && (
            <>
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">{transferData.recipientBank}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">{transferData.recipientName}</span>
              </div>
            </>
          )}
          ...
          {transferData.type === "mobile" && (
            <>
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">{transferData.provider}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Phone</span>
                <span className="text-sm font-medium">{transferData.recipientPhone}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Recipient</span>
                <span className="text-sm font-medium">{transferData.recipientName}</span>
