...
import { Phone, Mail, MapPin, Clock, MessageSquare, Send, Building, Users, Headphones } from "lucide-react"
        ...
        <Card className="border-red-200">
          ...
          <CardContent>
            <div className="bg-red-50 p-4 rounded-lg">
              <h3 className="font-medium text-red-800 mb-2">Lost or Stolen Card?</h3>
              <p className="text-sm text-red-700 mb-3">
                If your card is lost or stolen, contact us immediately to block it and prevent unauthorized use.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button variant="outline" className="flex-1 border-red-200 text-red-600 hover:bg-red-50 bg-transparent">
                  Block Card in App
                </Button>
              </div>
            </div>
