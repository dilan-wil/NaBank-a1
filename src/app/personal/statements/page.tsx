            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 mt-2 space-y-1">
                  <li>
                    • Statements are generated monthly and available for
                    download
                  </li>
                  <li>
                    • PDF format includes detailed transaction information
                  </li>
                  <li>
                    • CSV format is suitable for importing into spreadsheet
                    applications
                  </li>
