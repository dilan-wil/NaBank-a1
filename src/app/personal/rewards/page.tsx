    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Earn cashback and points on every transaction
        </p>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {totalCashback.toLocaleString()} FCFA
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Progress
            value={(availablePoints / nextTierPoints) * 100}
            className="h-3"
          />
          <p className="text-sm text-muted-foreground">
            Earn {nextTierPoints - availablePoints} more points to unlock Gold
            tier benefits
          </p>
        </CardContent>
      </Card>
            ...
            {rewardHistory.map((reward) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <Badge
                    variant={
                      reward.status === "credited" ? "default" : "secondary"
                    }
                    className="text-xs"
                  >
                    {reward.status}
