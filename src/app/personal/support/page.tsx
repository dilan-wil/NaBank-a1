  ...
  const faqItems = [
    {
      ...
      answer:
        "Go to Transfers > External Transfer, enter recipient details, amount, and confirm with your PIN.",
      category: "Transfers",
    },
    {
      id: "2",
    ...
    },
    {
      ...
      answer:
        "Go to Cards > Request New Card, choose virtual or physical, and follow the verification steps.",
      category: "Cards",
    },
    {
      id: "4",
      ...
      answer:
        "Go to Security > Two-Factor Authentication and toggle on SMS Authentication.",
      category: "Security",
    },
  ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Get help with your NaBank account and services
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground text-left">
                Complete guide to using NaBank
              </p>
            </Button>
