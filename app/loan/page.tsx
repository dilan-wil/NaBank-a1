    ...
    <AppLayout>
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Apply for personal or business loans with competitive rates</p>
        </div>
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div>
                    ...
                    <p className="text-lg font-semibold">{calculateMonthlyPayment().toLocaleString()} FCFA</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">
                      {(
                        calculateMonthlyPayment() * Number.parseInt(duration || "0") -
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">
                      {(calculateMonthlyPayment() * Number.parseInt(duration || "0")).toLocaleString()} FCFA
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Textarea id="purpose" placeholder="Describe what you'll use the loan for..." />
            </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{loan.amount.toLocaleString()} FCFA</p>
                    </div>
                  </div>
                ...
                {loan.status === "active" && (
                  <div className="grid grid-cols-2 gap-4 mt-3 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{loan.remaining.toLocaleString()} FCFA</p>
                    </div>
                    <div>
